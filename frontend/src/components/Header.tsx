...
import { Home, PlusSquare, Bell, User, Shield } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Avatar, AvatarFallback, AvatarImage } from '@/components/ui/avatar';
import { useGetUnreadNotificationsCount, useIsCallerAdmin, useGetCallerUserProfile } from '../hooks/useQueries';
...
export default function Header() {
  ...
  const avatarUrl = userProfile?.avatar ? getAvatarUrl(userProfile.avatar) : undefined;
